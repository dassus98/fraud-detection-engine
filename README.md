...
## Business Value & ROI
Financial institutions lose approx. 3-5% of revenue to fraud. Blocking legitimate transactions (False Positives) insults customers and drives churn, which can be more expensive in the long run. This project has three goals to bring to the organization:
